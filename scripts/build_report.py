...
def main() -> int:
    student = sys.argv[1] if len(sys.argv) > 1 else "Shreyansh Singh Gautam"
    repo = sys.argv[2] if len(sys.argv) > 2 else "https://github.com/Shreyanshsingh23/hld-typeahead"
    chash = commit_hash()
